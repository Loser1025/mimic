...
from .utils import safe_print, C, log, _try_read_file_text, cache_tool_output, _tool_output_cache, _TOOL_CHUNK_SIZE
...
@tools.register(
    ...
    description=(
        ...
        "例: read_tool_cache(cache_key=\"run_powershell_001\", offset=10000)"
    ),
    parameters={
        "type": "object",
        "properties": {
