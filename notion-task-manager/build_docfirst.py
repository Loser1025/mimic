...
PARENT_PAGE_ID = "327f0edf-6de5-80ca-8e3d-f58355162ea7"  # タスク進捗管理
...
# ============================================================
# 1. 親ページ作成：ドキュメント・ファースト運用
# ============================================================
print("1. 親ページ作成中...")
main_page = req("POST", "pages", {
    "parent": {"type": "page_id", "page_id": PARENT_PAGE_ID},
    "properties": {
        "title": {"title": [{"text": {"content": "ドキュメント・ファースト運用"}}]}
    }
})
...
db = req("POST", "databases", {
    "parent": {"type": "page_id", "page_id": main_id},
...
# ============================================================
print("4. ガイドページを構築中...")
req("PATCH", f"blocks/{main_id}/children", {"children": [
    {"object": "block", "type": "callout", "callout": {
    ...
    {"object": "block", "type": "numbered_list_item", "numbered_list_item": {"rich_text": [
        t("定例会議で最終判断", bold=True),
        t("→「採用」または「見送り」にステータス更新")
    ]}},
    ...
    {"object": "block", "type": "callout", "callout": {
        "rich_text": [t("新しい提案は「+新規」から追加。サンプルページのフォーマットを参考にしてください。")],
        "icon": {"type": "emoji", "emoji": "👇"},
        "color": "blue_background"
    }},
]})
...
print(f"\n完成!")
print(f"URL: https://www.notion.so/{main_id.replace('-', '')}")
