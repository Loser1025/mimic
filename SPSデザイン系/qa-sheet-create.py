...
body = json.dumps({
    ...
    'data': [{'range': 'Q\uff06A!A1', 'values': QA_DATA}]
}).encode()
urllib.request.urlopen(urllib.request.Request(
    f'https://sheets.googleapis.com/v4/spreadsheets/{SSID}/values:batchUpdate',
    data=body,
...
# ── Step 2: 書式設定 ─────────────────────────────────────
cat_colors = {
    'サービス・事務所': {'red': 0.851, 'green': 0.918, 'blue': 0.827},
    '手続きの種類':     {'red': 0.800, 'green': 0.886, 'blue': 0.953},
    '影響・デメリット': {'red': 1.000, 'green': 0.949, 'blue': 0.800},
    '費用・お金':       {'red': 0.949, 'green': 0.831, 'blue': 1.000},
    '断り文句':         {'red': 1.000, 'green': 0.851, 'blue': 0.800},
    '手続き中・後':     {'red': 0.851, 'green': 0.953, 'blue': 0.953},
}
...
requests.append({
    'repeatCell': {
        ...
        'cell': {'userEnteredFormat': {
            ...
            'textFormat': {'fontSize': 10, 'fontFamily': 'Meiryo UI'}
        }},
...
requests.append({
    'repeatCell': {
        ...
        'cell': {'userEnteredFormat': {
            'backgroundColor': {'red': 0.165, 'green': 0.384, 'blue': 0.490},
...
requests.append({
    'updateBorders': {
        ...
        'top':    {'style': 'SOLID_MEDIUM', 'color': {'red': 0.165, 'green': 0.384, 'blue': 0.490}},
        'bottom': {'style': 'SOLID_MEDIUM', 'color': {'red': 0.165, 'green': 0.384, 'blue': 0.490}},
        'left':   {'style': 'SOLID_MEDIUM', 'color': {'red': 0.165, 'green': 0.384, 'blue': 0.490}},
        'right':  {'style': 'SOLID_MEDIUM', 'color': {'red': 0.165, 'green': 0.384, 'blue': 0.490}},
    }
})
