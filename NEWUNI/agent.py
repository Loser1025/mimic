...
class GeminiAgent:
    ...
    def _compact_if_needed(self):
        ...
        api_key = self.rotator.accounts[0].api_key
        ...
        while attempt < MAX_RETRIES:
            ...
            try:
                ...
                if attempt == 0:
                    ...
                    struct = [
                        {"role": c["role"], "has_tool_calls": bool(c.get("tool_calls"))}
    ...
    def run(self, user_message: str) -> str:
        ...
        # ProjectRAG: 共有インスタンスを使用。未インデックスなら非同期で開始
        if self._project_rag:
            try:
                # 検索用キーを選択（待機なし）
                rag_acc, _ = self.rotator.pick()
                rag_key = rag_acc.api_key
